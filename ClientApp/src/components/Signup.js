  ...
  return (
    ...
    >
      <Modal show={showModal} onHide={closeModal} centered>
        ...
        <Modal.Body>
          {" "}
          {/* This is the new Modal.Body containing the input box */}
          <Form.Control
            type="text"
              ...
              <Card.Body>
                <div className="mb-3">
                  <div style={{ display: "flex", alignItems: "center" }}>
                    ...
                    >
                      <h2 className="register-title fw-bold mt-md-3 text-uppercase">
                        Register
                      </h2>
                      <p className="mb-0">
                        Hi! Please enter all information fields to register!
                      </p>
                    </div>
                  ...
                  <div className="mb-3">
                    ...
                    <div className="mt-3">
                      ...
                      <p className="mb-0 text-center">
                        {" "}
                        <em>
                          Register button not taking you to your portal? We
                          probably just need a minute to load your account. Just
                          wait and you'll be in shortly!
                        </em>{" "}
                      </p>
                    </div>
                  </div>
